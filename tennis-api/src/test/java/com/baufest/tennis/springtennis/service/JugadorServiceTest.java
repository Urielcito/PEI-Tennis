...
class JugadorServiceTest {
    ...
    public void setUp() {
        ...
        jugadorService = new JugadorServiceImpl(jugadorRepository,new JugadorMapperImpl(new EntrenadorMapperImpl()), partidoRepository);
    ...
    void testRecalcularRankingJugadorGanoUnPartidoDeLocal() {
        ...
        JugadorDTO jugadorDTO = this.jugadorService.recalcularRanking(1L);
