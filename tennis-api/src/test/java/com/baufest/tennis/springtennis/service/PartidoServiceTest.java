...
class PartidoServiceTest {
    ...
    Entrenador ENTRENADOR = new Entrenador(1L, "Uriel");
    EntrenadorDTO ENTRENADOR_DTO = new EntrenadorDTO(1L, "Uriel");

    Jugador jugador1 = new Jugador(1L, "Federer", SCORE_30, ENTRENADOR);
    Jugador jugador2 = new Jugador(2L, "Nadal", SCORE_30, ENTRENADOR);

    JugadorDTO jugadorDTO1 = new JugadorDTO(1L, "Federer", SCORE_30, ENTRENADOR_DTO);
    JugadorDTO jugadorDTO2 = new JugadorDTO(2L, "Nadal", SCORE_30, ENTRENADOR_DTO);
